...
CREATE TABLE transactions (
    ...
    amount INT NOT NULL,
    -- + for winning money, - for spending stuff
    transaction_type VARCHAR(50) NOT NULL,
    --for "win", "puchase", "loss maybe idk" 
...
CREATE TABLE battle_logs (
    ...
    -- moves made. maybe damage done since its an action based game. 
    timestamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    -- for tracking the sequence of moves
...
-- each row = “username X calls deck_id Y ‘My First Deck’ ”
